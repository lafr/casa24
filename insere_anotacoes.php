...
<div class='bloco_centro'><div class='content'>
    <fieldset>
        ...
        <form action="insere_anotacoes.php" method="POST">
            ...
            <span><label for="brindes">O posto forneceu brindes?</label><input type="radio" name="brindes" value="1" required>Sim</input><input type="radio" name="brindes" value="0">Não</input></span>
            <span><label for="msociais">O posto informou suas mídias sociais?</label><input type="radio" name="msociais" value="1" required>Sim</input><input type="radio" name="msociais" value="0">Não</input></span>
            <span><label for="contato_responsavel">Conseguiu contato com o responsável?</label><input type="radio" name="contato_responsavel" value="1" required>Sim</input><input type="radio" name="contato_responsavel" value="0">Não</input></span>
            <span><label for="show_posto">O posto organizou algum show?</label><input type="radio" name="show_posto" value="1" required>Sim</input><input type="radio" name="show_posto" value="0">Não</input></span>
            <span><label for="ab">O posto forneceu alimentos e/ou bebidas?</label><input type="radio" name="ab" value="1" required>Sim</input><input type="radio" name="ab" value="0">Não</input></span>
            <span><label for="promocao">O posto fez alguma promoção?</label><input type="radio" name="promocao" value="1" required>Sim</input><input type="radio" name="promocao" value="0">Não</input></span>     
            <span><label for="opiniao_visitantes">Qual foi a percepção dos visitantes?</label>
                <input type="radio" name="opiniao_visitantes" value="1" required>Fraca</input>
            ...
            <span><label for="opiniao_geral">Qual foi a sua opiniao?</label>
                <input type="radio" name="opiniao_geral" value="1" required>Fraca</input>
